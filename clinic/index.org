...
- Blog post [[https://www.hdfgroup.org/2022/03/parallel-compression-improvements-in-hdf5-1-13-1/][Parallel compression improvements in HDF5 1.13.1]]
  ...
  - IOR results from =cori= at NERSC
...
Focal points: application or service

**** Application-centric
***** Object
- Applications are completely isolated from storage details

#+begin_src plantuml :exports both :file ./img/object.png
@startuml
...
***** File
- Applications are potentially "exposed" to storage details via a file-centric
  view
  - HDF5 library + VFL
  - Target BLOBs directly (e.g., [[http://icesat2sliderule.org/h5coro/][H5Coro]])

#+begin_src plantuml :exports both :file ./img/file.png
@startuml
...
database "(P)FS" as PFS1 {
  file "HDF5 File" as file
}
cloud "(Cloud) Object Store" as COS1 {
...
#+begin_src plantuml :exports both :file ./img/service.png
@startuml
