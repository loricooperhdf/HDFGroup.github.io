...
Different focal points: _application_ or _service_

**** Application-centric
***** Object
- Applications are completely isolated from storage details

#+begin_src plantuml :file ./img/object.png
@startuml
...
#+begin_src plantuml :file ./img/file.png
@startuml
...
#+begin_src plantuml :file ./img/service.png
@startuml
