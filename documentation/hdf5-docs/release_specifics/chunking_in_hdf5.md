...
![Contiguous and chunked datasets](chunking1and2.png)
...
![Reading part of row and reading part of column from a contiguous dataset](chunking3and4.pgn)
...
![Reading part of a column from a chunked dataset](chunking5.png) 
...
![Reading a row from a chunked dataset with the chunk cache enabled](chunking6.png) 
 
![Reading a row from a chunked dataset with the chunks already cached](chunking7.png)
