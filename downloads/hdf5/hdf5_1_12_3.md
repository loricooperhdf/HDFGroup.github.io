...
| Release Notes | Release Notes <li>Tested Platforms and Configuration Features| 
...
| Information on Upgrading Applications to 1.12 | <span color=red>Should we include this? Do they have to stop at 1.12 if they are moving from lower to 1.14?</span>  
...
| HDF5 Plugins <span color=red>Link where?</span>	| Binary File	| Pre-built HDF5 plugin distributions for Unix and Windows	| Information on HDF5 Filter Plugins | - | 	 
